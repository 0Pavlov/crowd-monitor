...
# Task type
task_type = 'free'
# Gold standard answer (could be specified by admin or generated by the AI if not specified)
gsa = '3'
# Deadline
...
task = query(db, "INSERT INTO tasks (task_type, content, gold_standard_answer, deadline) VALUES (?, ?, ?, ?)", task_type, task_content, gsa, deadline)
```
